...
const headerData = {
    ...
    title: "Accelerators",
    description: `
    Startup advisory  has rich experience in working with accelerators. Our expert trainers’ workshops have received excellent feedback as they have prepared founders well for working on their challenges.

    At the Global Startup Awards 2023, Startup advisory  was named “Global Ecosystem Hero of the Year”. This recognition highlighted the successful work of the last ten years in educating startups and working with investors and accelerators.
    `,
